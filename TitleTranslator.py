...
#===============================================================================================================
title = r"""
The Ant and The Dove || Best Short Storie for Kids || Moral Story || KidsTime
"""

description = r"""
The Ant and The Dove || Best Short Storie for Kids
...
the ant saw hunter painting his arrow at the dove.

the ant knew that his friend, the Dove, was in danger.
He quickly bit the hunter's leg.
the hunter cried in pain.

the hunters arrow missed the dove. this time, the ant saved the Dove.
...
Music by RedProduction from Pixabay
RedProduction: https://pixabay.com/users/redproductions-970568/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=57026
